...
**Mark**:
1つの Cue と Timeline 上の1点との対応。Cue が開始する位置を表し、v1 では1つの Cue に対して canonical な Mark は最大1つとする。
...
**Mark a Cue**:
Cue に Timeline 上の位置を割り当て、Mark を作成または置き換える操作。既存の Mark を変更する場合も同じ語を使う。
